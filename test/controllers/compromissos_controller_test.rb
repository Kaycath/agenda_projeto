...
class CompromissosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compromisso" do
    assert_difference("Compromisso.count") do
      post compromissos_url, params: { compromisso: { data: @compromisso.data, descricao: @compromisso.descricao, horario: @compromisso.horario, titulo: @compromisso.titulo } }
    end
  ...
  test "should update compromisso" do
    patch compromisso_url(@compromisso), params: { compromisso: { data: @compromisso.data, descricao: @compromisso.descricao, horario: @compromisso.horario, titulo: @compromisso.titulo } }

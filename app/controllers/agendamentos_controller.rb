class AgendamentosController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @agendamento.update(agendamento_params)
        format.html { redirect_to @agendamento, notice: "Agendamento was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to agendamentos_path, notice: "Agendamento was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def agendamento_params
      params.expect(agendamento: [ :titulo, :data ])
    end
end
